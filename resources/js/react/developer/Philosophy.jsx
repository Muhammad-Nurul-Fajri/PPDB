...
export default function Philosophy() {
  return (
    <section className="py-[120px] relative overflow-hidden bg-slate-50/50 dark:bg-zinc-900/30">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          ...
          <span className="text-[14px] font-semibold text-blue-600 uppercase tracking-widest block">
          ...
          <p className="text-[14px] font-semibold text-slate-500 dark:text-zinc-400">
