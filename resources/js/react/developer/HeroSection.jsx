...
import { 
  Download, FolderGit2, Mail, Sparkles, Code2, MapPin, CheckCircle2, ArrowUpRight, Terminal, Cpu, ShieldCheck, Zap
} from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-50 dark:bg-indigo-950/80 border border-indigo-200/80 dark:border-indigo-800/80 text-indigo-700 dark:text-indigo-300 text-xs font-bold tracking-wide shadow-sm mb-6">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
              </span>
              <Terminal className="w-3.5 h-3.5 text-indigo-600 dark:text-indigo-400" />
              <span>Available for Hire &amp; Enterprise Contracts</span>
            </div>
            ...
            <p className="text-base sm:text-lg text-slate-600 dark:text-slate-400 mb-8 max-w-2xl leading-relaxed font-normal">
              I am a <strong className="text-slate-900 dark:text-white font-bold">Software Engineer &amp; Full Stack Web Specialist</strong>. Passionate about building scalable, high-performance web systems and user-centric digital applications using modern technologies.
            </p>
            ...
            {/* Key Value Badges */}
            <div className="grid grid-cols-3 gap-4 mb-8 p-4 rounded-2xl bg-white/60 dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800/80 backdrop-blur-md w-full max-w-xl">
          ...
          {/* Right Profile Photo Card & Developer Terminal */}
          <motion.div 
            ...
            <div className="relative w-full max-w-md">
              ...
              <div className="relative rounded-3xl overflow-hidden bg-slate-900 border border-slate-800/80 p-2.5 shadow-2xl backdrop-blur-xl">
                <div className="relative rounded-2xl overflow-hidden aspect-[3/4] bg-slate-800">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 p-4 rounded-2xl bg-slate-950/85 backdrop-blur-md border border-white/10 text-white flex items-center justify-between shadow-2xl">
                    <div>
              ...
              <div className="absolute -top-5 -left-4 bg-white dark:bg-slate-900 p-3.5 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 flex items-center gap-3 animate-bounce" style={{ animationDuration: '4s' }}>
                ...
                <div>
                  ...
                  <p className="text-xs font-extrabold text-slate-900 dark:text-white">Open for Projects</p>
                </div>
              </div>
